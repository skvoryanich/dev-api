...
class Toast {
    ...
    show({
        ...
        const l = Bs5Utils.defaults.styles[t],
            d = l.btnClose.join(" "),
            c = l.border,
...
class Snack {
    constructor() {
        _classPrivateFieldInitSpec(this, _count2, {
            writable: !0,
            value: 0
        })
    }
    show(t, e, s = 0, a = !0) {
        ...
        const o = Bs5Utils.defaults.styles[t],
            i = o.btnClose.join(" "),
            n = document.createElement("div");
        n.classList.add("toast","mb-3", "align-items-center"), o.main.forEach(t => {
            n.classList.add(t)
...
class Modal {
    constructor() {
        _classPrivateFieldInitSpec(this, _count3, {
            writable: !0,
            value: 0
        })
    }
    show({
        ...
        const b = Bs5Utils.defaults.styles[t],
            u = b.btnClose.join(" "),
            m = b.border,
...
function _createToastContainer2() {
    ...
    if (!t) {
        const e = {
            ...
            "bottom-left": "bottom-0 start-0 me-3 ms-3",
            "bottom-center": "bottom-0 start-50 translate-middle-x mb-1",
            "bottom-right": "bottom-0 end-0 me-3"
        };
